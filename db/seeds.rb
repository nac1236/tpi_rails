...
PhoneNumber.create(number:"460 1234", cliente_dependiente_id: ClienteDependiente.last.id )
ClienteDependiente.create(nombre:"Juan Perez", codigo_tipo_responsable:1, email:"juan@hotmail.com")
PhoneNumber.create(number:"460 3434", cliente_dependiente_id: ClienteDependiente.last.id )
ClienteDependiente.create(nombre:"Elias Sanchez", codigo_tipo_responsable:3, email:"elias@gmail.com")
PhoneNumber.create(number:"425 1234", cliente_dependiente_id: ClienteDependiente.last.id )
ClienteAutonomo.create(nombre:"Leandro Reynoso", codigo_tipo_responsable:3, email:"leandro@gmail.com", tipo_cliente: "persona")
PhoneNumber.create(number:"425 5555", cliente_dependiente_id: ClienteAutonomo.last.id )
ClienteAutonomo.create(razon_social:"El morenito", codigo_tipo_responsable:5, email:"morenito@gmail.com", tipo_cliente: "empresa")
PhoneNumber.create(number:"425 5050", cliente_dependiente_id: ClienteAutonomo.last.id )
PhoneNumber.create(number:"221 6437321", cliente_dependiente_id: ClienteAutonomo.last.id )